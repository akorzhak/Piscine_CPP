...
*/
    ...
    NinjaTrap    helen("Helen");
    NinjaTrap    ann("Ann");

    std::cout << "Helen can do Random Attack like FragTrap" << std::endl;
    helen.vaulthunter_dot_exe(ann.getName());
    ann.takeDamage(30);

    std::cout << "Helen can throw shoebox like NinjaTrap" << std::endl;
    helen.ninjaShoebox(ann);
    ann.ninjaShoebox(viki);
    return (0);
}